...
export const loader = async () => {
    ...
    return data.map((country: any) => ({
        name: country.name.common,           // Keep just the name here (string)
        coordinates: country.latlng,             // lat/lng from API
        value: country.name.common,              // Duplicate of name, used as value
    ...
    const mapData = [
        {
            country: formData.country,
            color: '#EA382E',
            coordinates: countries.find((c: Country) => c.name ===
            formData.country)?.coordinates || []
        }
    ]
                ...
                >
                    ...
                    <footer className='px-6 w-full'>
                        <ButtonComponent
                            ...
                            disabled={loading}
                        >
                            <img src={`/assets/icons/${loading ? 'loader.svg' :
                            'magic-star.svg'}`}
